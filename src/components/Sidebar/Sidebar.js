...
export default function Sidebar() {
  ...
  return (
    <div>
      ...
      <a
        href="https://drive.google.com/file/d/11iLxB2i00wkhZHh70h8V3Tm6CXxtrrfr/view?usp=sharing"
        target="_blank"
        rel="noreferrer"
        download="Resume.pdf"
      >
      ...
      <div className="sidebar-social-icons my-3">
        ...
        <a
          ...
          rel="noreferrer"
        >
          <BsTwitter className="sidebar-icon me-3" />
        </a>
        <a
          href="https://www.linkedin.com/in/mani-teja-aaa04721a/"
          target="_blank"
          rel="noreferrer"
        >
          <BsLinkedin className="sidebar-icon me-3" />
        </a>
        <a
          href="https://github.com/katammaniteja"
          target="_blank"
          rel="noreferrer"
        >
      ...
      <div className="sidebar-contact">
        <div className="sidebar-location">Rajahmundry(AP), India</div>
